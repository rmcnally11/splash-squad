...
const TUNES: number[][] = [
  ...
  [196, 247, 294, 392, 330, 262, 220, 247],
  [330, 392, 494, 587, 494, 392, 370, 440],
  [294, 370, 440, 587, 523, 440, 392, 494],
];
...
export const sfx = {
  ...
  gun(): void {
    beep(240, 0.035, "square", 0.045);
    beep(420, 0.04, "sawtooth", 0.03);
  },
  nuke(): void {
    beep(80, 0.28, "sawtooth", 0.09);
    beep(140, 0.22, "square", 0.07);
    beep(320, 0.18, "triangle", 0.06);
    beep(90, 0.32, "sawtooth", 0.05);
  },
  boom(): void {
